...
public class Kata8 {
    public static List<Map> execute() {
        ...
        List<Map> newListMovies = StreamUtils.zip(movies.stream(),
                bookMarks.stream(),(movie, bookMark) ->
                        Map.of("videoId ", movie.getId(), "bookmarkId ", bookMark.getId())).collect(Collectors.toList());
        // StreamUtils.zip()
